<?php
    ...
    switch($pageRequest){
        ...
        //Mantenimiento de Unidades
        case "materiales":
            require_once("controllers/mnt/materiales.control.php");
            break;
        case "materiale":
            require_once("controllers/mnt/materiale.control.php");
            break;
        ...
        case "almacen":
            ...
            //Mantenimiento de Unidades
        case "talmacenes":
            require_once("controllers/mnt/talmacenes.control.php");
            break;
        case "talmacen":
            require_once("controllers/mnt/talmacen.control.php");
            break;
